...
State&lt;[ZegoToggleMicrophoneButton](../../zego_uikit_prebuilt_live_audio_room/ZegoToggleMicrophoneButton-class.md)> createState
()
...
later inserted into the tree again, the framework will call <a href="../../zego_uikit_prebuilt_live_audio_room/ZegoToggleMicrophoneButton/createState.md">createState</a>
